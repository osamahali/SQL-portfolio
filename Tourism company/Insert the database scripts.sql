...
VALUES
    ...
    (1, 'Last week offers - Jeddah', 2790.00, 'Spend a week in most historical places with breakfast.', 'Jeddah'),
    ...
    (2, 'Relax and Spa package', 15000.00, 'Relax and refresh at our luxurious resorts.', 'Luxury Spa'),
    ...
    (4, 'Stars Night', 25000.00, 'Explore a dense cluster of stars in the outer reaches of our galaxy.', 'Scenic Adventure'),
    (5, 'Alula Tour', 8000.00, 'Experience the life with the oldest ancient nation.', 'Historic Tour'),
    (3, 'Family Package', 12000.00, 'Spend more time with yuor family with full board.', 'Family'),
    (1, 'Last week offers - Baha', 6794.00, 'Take a scenic tour of the majestic mountain around albaha.', 'Scenic Tour'),
    (6, 'turkey Offers', 6000.00, 'Witness the stunning city of istanbul.', 'Food and travel'),
    ...
    (6, 'North Amrica offers', 7000.00, 'cheapest travel to north amrica.', 'Budget travel'),
    (2, 'Domestic Packages - Riyadh', 6000.00, 'Find yourself in riyadh season .', 'Riyadh Season'),
    (10, 'Empty Quarter Adventure', 10000.00, 'Take an adventurous trip across empty quarter'' using cars and camels.', 'Exploration Tour');
